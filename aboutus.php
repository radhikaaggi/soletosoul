...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/bootstrap.css?v=10">
		...
		<div id="content">
			...
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Sole to Soul, the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
