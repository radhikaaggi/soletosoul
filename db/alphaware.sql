...
CREATE TABLE `admin` (
  ...
  `has_access_customer` tinyint(1) NOT NULL,
    `has_access_product` tinyint(1) NOT NULL,
    `has_access_order` tinyint(1) NOT NULL,
    `has_access_trans` tinyint(1) NOT NULL,
     `has_access_msg` tinyint(1) NOT NULL
...
INSERT INTO `admin`(`adminid`, `username`, `password`, `has_access_customer`, `has_access_product`, `has_access_order`, `has_access_trans`, `has_access_msg`) VALUES 
(1,'DBA','admin',1,1,1,1,1),
(2,'sales_manager','admin',0,0,1,1,0),
(3,'product_manager','admin',0,1,0,0,0),
(4,'customer_exe','admin',1,0,1,0,1);
