		...
		<!-- edit php -->
			...
			if (isset($_POST['edit']))
				...
				if(mysqli_num_rows($ck)>0){
					...
					if($up){
						header("location:admin_football.php?success=true");
					}else{
						header("location:admin_football.php?success=false");
					}

				}else{

					header("location:admin_football.php?err=false");
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='../function/remove.php?id=".$id."' class='btn btn-danger' ><i class='icon-minus-sign icon-white'></i> Remove</a> "; 
					?>
					</td>
				</tr>
				<?php
